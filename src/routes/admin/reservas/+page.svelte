<script lang="ts">
	...
	$: reservasFiltradas =
		filtro === 'TODOS' ? reservas : reservas.filter((r) => r.estado.estado === filtro);
			...
			<table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
				<thead class="bg-gray-50 dark:bg-gray-800/50">
					<tr>
						...
						>
						<th
							class="px-4 py-3 text-right text-xs font-semibold tracking-wider text-gray-500 uppercase dark:text-gray-400"
							>Acciones</th
						>
					</tr>
				</thead>
						...
						<tr class="hover:bg-gray-50 dark:hover:bg-gray-800/40">
							...
							<td class="px-4 py-3">
								...
								{:else if r.estado.estado === 'PENDIENTE'}
									<span
										class="rounded-full bg-yellow-100 px-3 py-1 text-xs font-semibold text-yellow-700 dark:bg-yellow-900/40 dark:text-yellow-300"
									>
										Pendiente
									</span>
								{:else}
							...
							<td class="px-4 py-3 text-sm text-blue-600 hover:underline dark:text-blue-400">
